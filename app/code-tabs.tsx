...
const SAMPLES: Sample[] = [
  ...
  },
  {
    ...
    code: [
      ...
      [
        ...
        ["prop", "weights"],
        ["mod", "="],
        ["str", '"resnet50_sentinel2_all_moco"'],
        ["mod", ","],
      ],
      [
        ["mod", "    "],
  ...
  },
  {
    ...
    desc: (
      <>
        Mask R-CNN with a torchvision-style box head, trained on ten classes —
        courts, harbors, vehicles, ships. Same trainer, different head.
      </>
    ),
    bullets: [
      ["10 classes", "baseball diamonds, tennis courts, harbors, planes…"],
      ["Mask R-CNN", "instance masks in addition to bounding boxes."],
